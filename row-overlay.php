...
class addons_row_overlay extends Widget_Base {
	...
	protected function render() {
        ...
        $shortcode_content .= do_shortcode('[mt-row-overlay page_builder="elementor" image_groups="'.$serialized_image_groups.'" background="'.$background.'" inner_column="'.$inner_column.'"  moving_images_grid="'.$moving_images_grid.'" images_gap="'.$images_gap.'"]');
