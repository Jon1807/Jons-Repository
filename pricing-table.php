...
class addons_pricing_table extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'button_url',
			[
				'label' => __( 'Pricing Button', 'modeltheme-addons-for-wpbakery' ),
				'label_block' => true,
	...
	protected function render() {
        ...
        $shortcode_content .= do_shortcode('[mt-addons-pricing-table page_builder="elementor" pricing_groups="'.$serialized_pricing_groups.'" style_var="'.$style_var.'" package_name="'.$package_name.'" title_align="'.$title_align.'" title_size="'.$title_size.'"  section_align="'.$section_align.'"  package_price="'.$package_price.'" price_size="'.$price_size.'" package_currency="'.$package_currency.'" package_description="'.$package_description.'" description_size="'.$description_size.'" content="'.$content.'" button_url="'.$btn_atts.'" font_size="'.$font_size.'" btn_size="'.$btn_size.'" button_bg_color="'.$button_bg_color.'" package_background_title="'.$package_background_title.'" package_background_color="'.$package_background_color.'" package_bg_color_hover="'.$package_bg_color_hover.'" package_name_color="'.$package_name_color.'" price_color="'.$price_color.'" package_description_color="'.$package_description_color.'" border_color="'.$border_color.'" inline_row="'.$inline_row.'" no_container_row="'.$no_container_row.'"]');
