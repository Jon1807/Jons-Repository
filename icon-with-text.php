...
class addons_icon_with_text extends Widget_Base {
        ...
        $this->start_controls_section(
         ...
         $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mt-icon-listgroup-title',
            ]
        ); 
        $this->add_control(
			'title_tag',
	...
	protected function render() {
        ...
        $shortcode_content .= do_shortcode('[mt-addons-icon-list page_builder="elementor" icon_url="'.$btn_atts.'" section_aligment="'.$section_aligment.'" icon_position="'.$icon_position.'"  icon_color="'.$icon_color.'" title_color_hover="'.$title_color_hover.'" style_block="'.$style_block.'" icon_type="'.$icon_type.'" icon_size="'.$icon_size.'" title="'.$title.'" title_size="'.$title_size.'"  title_color="'.$title_color.'" subtitle="'.$subtitle.'" subtitle_color="'.$subtitle_color.'" elementor_icon_fontawesome="'.$elementor_icon_fontawesome.'"  image="'.$image_id.'" use_svg="'.$image_svg.'" subtitle_tag="'.$subtitle_tag.'" title_tag="'.$title_tag.'" bg_color="'.$bg_color.'" style_bg="'.$style_bg.'" background_box_color="'.$background_box_color.'" style_margin_top="'.$style_margin_top.'" margin_right="'.$margin_right.'"  image_max_width="'.$image_max_width.'" box_border_radius="'.$box_border_radius.'"]' );
