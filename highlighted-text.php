...
class addons_highlighted_text extends Widget_Base {
	...
	protected function render() {
        ...
        $shortcode_content .= do_shortcode('[mt-addons-highlighted-text page_builder="elementor" texts_groups="'.$serialized_texts_groups.'" highlight_color="'.$highlight_color.'"  color="'.$color.'" aligment="'.$aligment.'" title_size="'.$title_size.'" title_line="'.$title_line.'" title_weight="'.$title_weight.'"]');
