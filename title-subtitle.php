...
class addons_title_subtitle extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'My Title', 'modeltheme-addons-for-wpbakery' ),
				'label_block' => true,
